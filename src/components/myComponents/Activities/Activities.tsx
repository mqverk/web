    ...
    <section className="mt-16 space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          <ActivityCard icon={MapPin} label="Location" actionIcon={false} className="min-h-[75px]">
            <div className="leading-tight text-[11px] mt-1">
              <LocationTime />
            </div>
          </ActivityCard>

          <ActivityCard icon={BookOpen} label="Reading" actionIcon={false} className="min-h-[75px]">
            <span className="block mt-1 text-[11px] truncate" title="LOTM >.<">
              LOTM {'>.<'}
            </span>
          </ActivityCard>

          <ActivityCard icon={Monitor} label="Watching" actionIcon={false} className="min-h-[75px]">
            <span className="block mt-1 text-[11px] truncate" title="Open-Source 👒">
              Open-Source 👒
            </span>
          </ActivityCard>

          <ActivityCard icon={Zap} label="Status" actionIcon={false} className="min-h-[75px]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-1 gap-2 sm:gap-3">
            ...
            {isDesktop && (
              <ActivityCard
                ...
                label="Oneko"
                onClick={toggleOneko}
                className="min-h-[80px] sm:hidden lg:block"
              >
