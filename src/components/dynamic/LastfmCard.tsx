                  ...
                  <div className="relative shrink-0">
                    {currentTrack.albumArt ? (
                      <img
                        ...
                        alt=""
                        className="w-[76px] h-[76px] rounded-xl object-cover shadow-md"
                      />
                    ) : (
                      <div className="w-[76px] h-[76px] rounded-xl bg-zinc-800 flex items-center justify-center">
              ...
              <div className="flex items-center gap-3">
                {data.topTrack.albumArt ? (
                  <img
                    ...
                    alt=""
                    loading="lazy"
                    className="w-[76px] h-[76px] rounded-xl object-cover shadow-md group-hover:scale-105 transition-transform shrink-0"
                  />
                ) : (
                  <div className="w-[76px] h-[76px] rounded-xl bg-zinc-800 flex items-center justify-center shrink-0">
                    <Music2 className="w-4 h-4 text-zinc-600" />
                  </div>
                )}
